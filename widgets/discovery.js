...
var isKeyable = __webpack_require__(43);
...
exports.AVAILABLE_CUSTOM_FIELDS_FOR_THEME = exports.CUSTOM_THEME_ATTRIBUTES = exports.ATTRIBUTE_VALUES = exports.ATTRIBUTE_NAMES = undefined;

var _AVAILABLE_CUSTOM_FIE;

var _without = __webpack_require__(69);
...
var ATTRIBUTE_VALUES = exports.ATTRIBUTE_VALUES = {
  WIDGET_THEME: {
    SIMPLE: 'simple',
...
var CUSTOM_THEME_ATTRIBUTES = exports.CUSTOM_THEME_ATTRIBUTES = [ATTRIBUTE_NAMES.TITLE_COLOR, ATTRIBUTE_NAMES.TITLE_HOVER_COLOR, ATTRIBUTE_NAMES.ARROW_COLOR, ATTRIBUTE_NAMES.ARROW_HOVER_COLOR, ATTRIBUTE_NAMES.EVENT_DATE_COLOR, ATTRIBUTE_NAMES.EVENT_DESCRIPTION_COLOR, ATTRIBUTE_NAMES.EVENTS_COUNTER_COLOR, ATTRIBUTE_NAMES.BORDER_COLOR, ATTRIBUTE_NAMES.BACKGROUND_COLOR];

var AVAILABLE_CUSTOM_FIELDS_FOR_THEME = exports.AVAILABLE_CUSTOM_FIELDS_FOR_THEME = (_AVAILABLE_CUSTOM_FIE = {}, _defineProperty(_AVAILABLE_CUSTOM_FIE, ATTRIBUTE_VALUES.WIDGET_THEME.SIMPLE, (0, _without2.default)(CUSTOM_THEME_ATTRIBUTES, ATTRIBUTE_NAMES.BACKGROUND_COLOR)), _defineProperty(_AVAILABLE_CUSTOM_FIE, ATTRIBUTE_VALUES.WIDGET_THEME.OLD_SCHOOL, CUSTOM_THEME_ATTRIBUTES), _defineProperty(_AVAILABLE_CUSTOM_FIE, ATTRIBUTE_VALUES.WIDGET_THEME.NEW_SCHOOL, CUSTOM_THEME_ATTRIBUTES), _defineProperty(_AVAILABLE_CUSTOM_FIE, ATTRIBUTE_VALUES.WIDGET_THEME.LIST_VIEW, (0, _without2.default)(CUSTOM_THEME_ATTRIBUTES, ATTRIBUTE_NAMES.ARROW_COLOR, ATTRIBUTE_NAMES.ARROW_HOVER_COLOR)), _defineProperty(_AVAILABLE_CUSTOM_FIE, ATTRIBUTE_VALUES.WIDGET_THEME.LIST_VIEW_THUMBNAILS, (0, _without2.default)(CUSTOM_THEME_ATTRIBUTES, ATTRIBUTE_NAMES.ARROW_COLOR, ATTRIBUTE_NAMES.ARROW_HOVER_COLOR)), _AVAILABLE_CUSTOM_FIE);
...
var SetCache = __webpack_require__(18),
    arrayIncludes = __webpack_require__(20),
...
var baseFindIndex = __webpack_require__(24),
    baseIsNaN = __webpack_require__(27),
    strictIndexOf = __webpack_require__(61);
...
var baseDifference = __webpack_require__(23),
    ...
    isArrayLikeObject = __webpack_require__(66);
...
var _widgetsAnalytics = __webpack_require__(13);
...
var _universePlugin = __webpack_require__(11);
...
_widgetsAnalytics2.default.initialize(_widgetsAnalytics.EVENT_CATEGORY.EVENT_DISCOVERY_WIDGET);
...
var TicketmasterEventDiscoveryWidget = function () {
  ...
  function TicketmasterEventDiscoveryWidget(root) {
    ...
    if (this.widgetRoot.querySelector('.events-root-container') === null) {
      ...
      this.defaultAnalyticsProperties = _defineProperty({
        eventCategory: _widgetsAnalytics.EVENT_CATEGORY.EVENT_DISCOVERY_WIDGET
  ...
  _createClass(TicketmasterEventDiscoveryWidget, [{
    ...
    value: function parseEvents(eventsSet) {
      ...
      for (var key in eventsSet) {
        if (eventsSet.hasOwnProperty(key)) {
          ...
          currentEvent.url = _url2.default.addParamToUrl(eventsSet[key].url, _widgetsAnalytics.SHARED_ID_ATTRIBUTE_NAME, _widgetsAnalytics.SHARED_ID_FOR_WIDGET.DISCOVERY);
    ...
    value: function createDOMItem(itemConfig) {
      ...
      if (this.isListView || this.isListViewThumbnails) {
        this.addBuyButton(!this.isListViewThumbnails ? medWrapper : wrapperImg, itemConfig.url);
      }
