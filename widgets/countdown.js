...
var _universePlugin = __webpack_require__(58);
     ...
     messageClose.addEventListener("click", ()=> {
       this.hideMessage();
		...
		value: function parseEvent(eventSet) {
			...
			currentEvent.url = _url2.default.addParamToUrl(eventSet.url, _widgetsAnalytics.SHARED_ID_ATTRIBUTE_NAME, _widgetsAnalytics.SHARED_ID_FOR_WIDGET.COUNTDOWN);
...
var _TicketmasterCountdownWidget = __webpack_require__(13);
